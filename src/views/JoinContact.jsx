...
const JoinContact = () => {
  return (
    <section className='lg:flex gap-16 mt-10 lg:m-8 px-5 lg:px-20 py-10 bg-gray-500 rounded-2xl'>
      ...
      <article className='lg:w-1/2 text-left text-white'>
      <h2 className='text-xl lg:text-3xl font-bold my-5 capitalize'>Join our weekly digest</h2>
      <p className='capitalize text-lg lg:text-xl'>Get exclusive promotions & updates straight to your inbox.</p>
